...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [657886.191387, 6957108.059205, 837759.972135, 7094915.678813], maxZoom: 14, minZoom: 9
    })
});
...
map.getView().fit([657886.191387, 6957108.059205, 837759.972135, 7094915.678813], map.getSize());
